  ...
  return (
    <Container>
      <Slot>
        <h1>Our Mission</h1>
        <p>
          To be the most recognised premier organisation in washing and dyeing
      ...
      <Slot>
        <h1>Our Vision</h1>
        <p>
          To provide highest return to our valuable customers with Innovative
          and Continuous Sustainable Improvements of our service.
        </p>
        <p>
          To become a Green Washing Plant that practices Globally Recognised
        ...
        <ul>
          ...
          <a href="./p4.pdf">
            <div class="notification">
              ...
              <div class="notiborderglow"></div>
              <div class="notititle">
                Anti-Harassment and Non-Abusive Policy
              </div>
            </div>
          </a>
...
const Policies = styled.div`
  ...
  li {
    ...
    margin: 10px 0;
    background: linear-gradient(#fff, #fff) padding-box,
      linear-gradient(145deg, transparent 35%, var(--sec), var(--sec))
        border-box;
  }
